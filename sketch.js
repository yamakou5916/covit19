const cwidth=[800,1000,1200,750,1000,1250,1000,250,550,300,650,1000,1350,1600,1400,1700];
const cheight=[200,150,200,500,400,500,700,500,650,800,850,900,850,800,600,450];
...
const lSize = [0];
const collision = 0;
const bigText = ["輸入量","為替","輸出量","景気動向指数","GDP","全産業活動指数","株価","販売金額指数","消費者態度指数","国外の\n人流移動量","国内の\n人流移動量","人流滞在量","他県からの\n移住者数","完全失業率","倒産数\n負債総額","雇用形態\n非正規率"];
