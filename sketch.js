...
function mouseClicked(){
  ...
  }else if(mouseX < cwidth[1]+150 & mouseX > cwidth[1]-150 & mouseY < cwidth[1]+150 & mouseY > cheight[1]-150){
    location.href = 'https://yamakou5916.com#section08';
  }else if(mouseX < cwidth[2]+150 & mouseX > cwidth[2]-150 & mouseY < cwidth[2]+150 & mouseY > cheight[2]-150){
    location.href = 'https://yamakou5916.com#section01';
  }else if(mouseX < cwidth[3]+150 & mouseX > cwidth[3]-150 & mouseY < cwidth[3]+150 & mouseY > cheight[3]-150){
    location.href = 'https://yamakou5916.com#section00';
  }else if(mouseX < cwidth[4]+150 & mouseX > cwidth[4]-150 & mouseY < cwidth[4]+150 & mouseY > cheight[4]-150){
    //location.href = 'https://yamakou5916.com/#section04';
  }else if(mouseX < cwidth[5]+150 & mouseX > cwidth[5]-150 & mouseY < cwidth[5]+150 & mouseY > cheight[5]-150){
    location.href = 'https://yamakou5916.com#section03';
  }else if(mouseX < cwidth[6]+150 & mouseX > cwidth[6]-150 & mouseY < cwidth[6]+150 & mouseY > cheight[6]-150){
    //location.href = 'https://yamakou5916.com/#section06';
  }else if(mouseX < cwidth[7]+150 & mouseX > cwidth[7]-150 & mouseY < cwidth[7]+150 & mouseY > cheight[7]-150){
    location.href = 'https://yamakou5916.com#section04';
  }else if(mouseX < cwidth[8]+150 & mouseX > cwidth[8]-150 & mouseY < cwidth[8]+150 & mouseY > cheight[8]-150){
    location.href = 'https://yamakou5916.com#section05';
  }else if(mouseX < cwidth[9]+150 & mouseX > cwidth[9]-150 & mouseY < cwidth[9]+150 & mouseY > cheight[9]-150){
    location.href = 'https://yamakou5916.com#section06';
  }
