const cwidth=[800,1000,1200,450,700,1300,1550,1000,250,550,300,650,1000,1350,1500,1200,1400];
const cheight=[150,250,150,300,400,400,300,650,500,650,800,850,800,850,800,600,650];
...
var rSize =[500,500,500,500,500,500,500,500,500,500,500,500];
var rSize0 =[300,300,250,250,350,400,300,250,350,400,300,300,300,400,300,300,400,300];
const lSize = [0];
const collision = 0;
const bigText = ["輸入量","為替","輸出量","景気動向指数","GDP","GDP","全産業活動指数","株価","販売金額指数","消費者態度指数","国外の\n人流移動量","国内の\n人流移動量","人流滞在量","他県からの\n移住者数","完全失業率","倒産数\n負債総額","雇用形態\n非正規率"];
