const cwidth=[400,1150,200,500,1500,1100,1500,800,1550,1150,750];
const cheight=[450,800,500,750,850,250,300,750,600,600,300];
...
function mouseClicked(){
  if(mouseX < cwidth[0]+rSize0[0]/2 & mouseX > cwidth[0]-rSize0[0]/2 & mouseY < cwidth[0]+rSize0[0]/2 & mouseY > cheight[0]-rSize0[0]/2){
    ...
    location.href = 'https://yamakou5916.com/#section09';
  }
