const cwidth=[800,1200,550,1000,1500,250,550,300,650,800,1350,1600,1400,1700];
const cheight=[150,150,300,400,300,500,550,800,850,550,850,800,600,450];
...
const lSize = [0];
const collision = 0;
const bigText = ["輸入量","輸出量","景気動向指数","GDP","全産業活動指数","販売金額指数","消費者態度指数","国外の\n人流移動量","国内の\n人流移動量","人流滞在量","他県からの\n移住者数","完全失業率","倒産数\n負債総額","雇用形態\n非正規率"];
