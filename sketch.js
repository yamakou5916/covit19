...
const lSize = [0];
const collision = 0;
const bigText = ["Living Sphere","Customer Touchpoint","Shopping Basket","Work Place","Management Style","Social Relation","Business Sentiment","Regulatory","Supply Chain","販売金額指数","他県からの\n移住者数","完全失業率","倒産数\n負債総額","雇用形態\n非正規率"];
