...
function csv2Array4(str,a) {
  ...
  for (var i = lines4.length-num0; i < lines4.length-num1; ++i) {
...
function drawBarChart4(data) {
  ...
  type: 'bar',  
    data: {
      labels: tmpLabels4,
      datasets: [
        { label: "倒産数（件）", data: tmpData14, borderColor: colors[0], borderWidth: 1, pointRadius: 0, yAxisID: "y-axis-1", backgroundColor: colors[0]},
        { type: 'line',label: "負債総額（万円）", data: tmpData24, borderColor: colors[1], borderWidth: 1, pointRadius: 0,yAxisID: "y-axis-2", backgroundColor: "rgba(255,255,255,0)"},
      ]
    },
