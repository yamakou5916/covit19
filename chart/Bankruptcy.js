...
function csv2Array4(str,a) {
  ...
  bankrupt = ((1-(beforeafter[12][2]/beforeafter[0][2]))*100).toFixed(1);
...
function drawBarChart4(data) {
  ...
  type: 'bar',  
    data: {
      labels: tmpLabels4,
      datasets: [
        { label: "倒産数【件】", data: tmpData14, borderColor: colors[4], borderWidth: 1, pointRadius: 0, yAxisID: "y-axis-1", backgroundColor: colors[4]},
