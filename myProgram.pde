float a=0; 
int cwidth[]={220,520,290,780,950,1050, 650};
int cheight[]={180,255,580,150,600,250,700};
int owidth[]={100,770,410,400,550,880, 510,1150,930,750};
int oheight[]={600,670,90,300,400,270,700,550,450,270};
int cnt = 0;
int textnum = 0;
float rSize[] = {250,300,100,200,180,400,300};
String bigText[][]=
{{"不正なビジネスが流行る","不正なビジネスを取り締まる"},
{"市場の失敗","市場の自浄効果"},
{"短期的な感染対策をとる","感染が沈静化する"},
{"政府や外国の引き締め","政府や外国からの支援"},
{"予防習慣が定着する","予防習慣が定着する"},
