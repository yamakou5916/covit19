float a=0; 
int cwidth[]={860,1030,290,1080,530, 350,570,750};
int cheight[]={180,555,380,270,500,700,200,520};
int owidth[]={100,770,610,900,1050,740, 510,1150,630,1100};
int oheight[]={600,670,140,300,400,400,700,550,450,800};
int cnt = 0;
int loopcnt = 0;
int textnum = 0;
float rSize[] = {200,400,100,160,180,500,300,270};
String bigText[][]=
{{"ストレージの内容を変更する\n（＋）貯蓄行動：備蓄品の増加","ストレージの内容を変更する\n（ー）貯蓄行動：廃棄の増加"},
{"清潔感への配慮は当たり前に\n（＋）企画行動：","清潔感への配慮は当たり前に\n（ー）企画行動："},
{"感染症への対応\n（＋）市場の自浄効果","感染症への対応\n（ー）市場の失敗：オーバーシュート"},
{"経済的ストレスを感じる\n（＋）投資行動：市場統制","経済的ストレスを感じる\n（ー）投資行動：市場パニック"},
{"人との不要な接触が不快に\n（＋）販売行動：","人との不要な接触が不快に\n（ー）販売行動：オペレーションの省人化"},
{"プロセス内の無駄・リスクを省く\n（＋）生産行動：デジタル化","プロセス内の無駄・リスクを省く\n（ー）生産行動：デジタル化"},
{"コト・トキ消費からウチ消費へ\n（ー）消費行動：広まる自粛ムード","コト・トキ消費からウチ消費へ\n（＋）消費行動：巣ごもり消費"},
{"物の触り方が変わる（＋）流通行動：。物の触り方が変わる（ー）流通行動："},
};
String smallText0[][]=
{{"ネットで\n転売する", "株価下落を\n狙った空売り", "過剰購入\n買い占め", "認可外の\n医療品の流通"},
{"不安が\n伝播する", "医療機関の\nパニック", "医療品・人員が\n足りない", "医療格差が\n拡大する"},
