float a=0; 
int cwidth[]={540,1030,1060,430, 950,300,750};
int cheight[]={220,655,250,800,800,500,620};
...
PImage img;
float rSize0[] ={500,600,560,580,700,700,470};
float rSize[] = {500,600,560,580,700,700,470};
float radius  = 200;
int collision = 0;
color col1, col2;
