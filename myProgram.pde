float a=0; 
int cwidth[]={240,830,640,560,730, 1050,400,800};
int cheight[]={870,1155,180,1050,500,800,500,820};
int owidth[]={550,570,560,550,640,740, 260,850,1030,760};
int oheight[]={910,670,1140,350,310,400,650,1350,1070,920};
int cnt = 0;
int loopcnt = 0;
int textnum = 0;
PImage img;
float rSize0[] = {200,400,300,360,380,500,500,270};
float rSize[] = {200,400,300,360,380,500,500,270};
String bigText[][]=
...
void BigCircle(int i){
   ...
   if(textnum==1){
     fill(0, 100+ rSize[i]/3, 255-rSize[i]/3 , 200-rSize[i]/3);
     noStroke();
   }else{
     noFill();
     stroke(250,250,250);
