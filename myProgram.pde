float a=0; 
int cwidth[]={200,600,200,200,1100,500,1100,500,1100,800,800};

int cheight[]={200,800,800,500,800,200,500,500,200,500,200};
  ...
  for(int i=0; i<cwidth.length;i++){
    ...
    if(sin(radians(frameCnt[i])) == 1){
        ...
        */
        fill(0);
        noStroke();
        image(images[i], cwidth[i]-15, cheight[i]+70-rSize0[i]/4, 40, 40);
        textSize(12);
