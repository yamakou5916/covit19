...
int cheight[]={770,1155,180,1050,300,800,500,820};
int owidth[]={400,770,610,400,1050,740, 210,1150,1030,1100};
int oheight[]={800,670,1040,300,400,400,550,1050,1070,800};
int cnt = 0;
int loopcnt = 0;
int textnum = 0;
