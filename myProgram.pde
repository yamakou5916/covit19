float a=0; 
int cwidth[]={240,830,440,560,830, 950,400,800,780};
int cheight[]={920,1255,180,1150,500,800,600,820,230};
...
PImage img;
float rSize0[] = {300,400,300,360,380,500,500,270,100};
float rSize[] = {500,600,500,560,580,700,700,470,300};
float radius  = 200;
int collision = 0;
color col1, col2;
...
String bigText[][]=
{{"ストレージの内容を変更する","ああああああ", "保有者"},
{"清潔感への配慮は当たり前に","ああああああ", "企画・設計者"},
{"予防・一次対応への意識向上","ああああああ", "病人"},
{"経済的ストレスを負担に","ああああああ", "投資家"},
{"人との不要な接触が不快に","ああああああ", "販売者"},
{"プロセス内の無駄・リスクに気づく","ああああああ", "生産者"},
{"コト・トキ消費からウチ消費へ", "消費の自粛","消費者"},
{"物の届き方が変わる","ああああああ", "流通ライン"},
};
